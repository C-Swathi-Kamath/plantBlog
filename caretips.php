      ...
      <ul class="navbar-nav ms-auto">
        ...
        <section id="caretips">
            ...
            <div class="col-lg-5 mx-auto">
              ...
              <ol class="carelist fs-5 lh-lg">
                <li><a href="flowercare.php" class="text-decoration-none link-success">Flowering plants</a></li>
                <li><a href="veggiecare.php" class="text-decoration-none link-success">Vegetable plants</a></li>
                <li><a href="cacticare.php" class="text-decoration-none link-success">Cacti and succulents</a></li>
                <li><a href="bonsaicare.php" class="text-decoration-none link-success">Bonsai</a></li>
                <li><a href="crotoncare.php" class="text-decoration-none link-success">Crotons</a></li>
               </ol>
            </div>
