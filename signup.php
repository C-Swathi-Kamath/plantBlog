      ...
      <div class="col-lg-6 col-md-6 mt-3 px-5 ms-5">
        ...
        <form>
          <div class="mb-3">
            ...
            <input type="text" class="signup-input form-control" id="name" placeholder="Name" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="signup-input form-control" id="cpassword" placeholder="Confirm Password"
              required>
          </div>
